...
const ClientProfilePage = () => {
    ...
    if (!user) return <div className="p-8 text-white">Client not found</div>;

    return (
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href="/su/clients" className="text-slate-400 hover:text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 text-center">
                        ...
                        <span className="px-3 py-1 bg-blue-500/20 text-blue-400 rounded-full text-sm font-medium uppercase">
                            {user.role_display}
                        </span>
                        {user.client_id && (
                            <div className="mt-4 text-sm text-slate-500">
                                Client ID: <span className="text-white font-mono">{user.client_id}</span>
                            </div>
                        )}
                    </div>
                </div>
