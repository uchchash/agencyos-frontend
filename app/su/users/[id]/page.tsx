        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href="/su/users" className="text-slate-400 hover:text-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-slate-900 border border-slate-700 rounded-2xl p-6 text-center">
                        ...
                        <span className="px-3 py-1 bg-slate-800 text-slate-300 rounded-full text-sm font-medium uppercase">
                            {user.role_display}
                        </span>
                    </div>
                </div>
