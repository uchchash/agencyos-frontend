...
const UniversityList: React.FC<UniversityListProps> = ({ refreshTrigger, onEdit }) => {
                        ...
                        <tbody className="divide-y divide-slate-700/50">
                            {loading ? (
                                ...
                                universities.map((uni) => (
                                    <tr key={uni.id} className="hover:bg-slate-800/30 transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="font-medium text-white">{uni.name}</div>
                                            <div className="text-xs text-slate-500 truncate max-w-[200px]">{uni.website}</div>
                                        </td>
                                        <td className="px-6 py-4 capitalize">{uni.university_type}</td>
                                        <td className="px-6 py-4">
                                            {uni.city_name}, {uni.country_name}
                                        </td>
                                        <td className="px-6 py-4">
                                            {uni.is_active ? (
